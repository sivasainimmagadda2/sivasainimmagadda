    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const items = await sp.web.lists.getByTitle("WorkFlowProcessData").items.filter(`AuthorId eq ${currentUser.Id}`).get();
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ width: "71vw" }}>
                    <p className="fo-ap" style={{ width: "100%" }}>My Documents</p>
                    {loading ? (
                        <LoadingSpinner/>
                    ) : (
                        <DataTable
